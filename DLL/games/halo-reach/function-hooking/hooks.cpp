...
game_time_get_speed* game_time_get_speed_og = reinterpret_cast<game_time_get_speed*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) +
	haloreach::function_offsets::game_time_get_speed_offset);
...
game_time_set_rate_scale_direct* game_time_set_rate_scale_direct_og = reinterpret_cast<game_time_set_rate_scale_direct*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) +
	haloreach::function_offsets::game_time_set_rate_scale_direct_offset);
...
weapon_get_owner_unit_index* weapon_get_owner_unit_index_og = reinterpret_cast<weapon_get_owner_unit_index*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) +
	haloreach::function_offsets::weapon_get_owner_unit_index_offset);
...
player_index_from_unit_index* player_index_from_unit_index_og = reinterpret_cast<player_index_from_unit_index*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) +
	haloreach::function_offsets::player_index_from_unit_index_offset);
...
unit_start_running_blindly* run_blindly = reinterpret_cast<unit_start_running_blindly*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) +
	haloreach::function_offsets::unit_start_running_blindly_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::actor_perception_set_target_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::weapon_barrel_create_projectiles_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::weapon_barrel_fire_weapon_heat_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::weapon_has_infinite_ammo_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::game_update_offset);
...
{
	long long* pointer = reinterpret_cast<long long*>(reinterpret_cast<char*>(GetModuleHandle("haloreach.dll")) + haloreach::function_offsets::unit_update_offset);
