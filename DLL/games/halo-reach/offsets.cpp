...
int haloreach::offsets::game_update_offset = 0x49F7C;
...
int haloreach::offsets::game_time_set_rate_scale_direct_offset = 0x5251C;

int haloreach::offsets::game_time_get_speed_offset = 0x51DB8;
